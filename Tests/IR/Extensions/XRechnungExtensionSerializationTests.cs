...
public class SerializationTests
{
    ...
    public void SerializeInvoice()
    {
            ...
            <invoice xmlns="urn:todo">
              ...
              <process-control id="bg-2">
                ...
                <specification-identifier id="bt-24">
                  <content>urn:cen.eu:en16931:2017#compliant#urn:xeinkauf.de:kosit:xrechnung_3.0#conformant#urn:xeinkauf.de:kosit:extension:xrechnung_3.0</content>
                      ...
                      <sub-invoice-line-item-information id="bg-dex-02">
                        ...
                        <sub-invoice-line-item-attributes id="bg-dex-08">
                          <sub-invoice-line-item-attribute id="bg-dex-08">
                            <item-attribute-name id="bt-160">[Description]</item-attribute-name>
                            <item-attribute-value id="bt-161">[Value]</item-attribute-value>
                          </sub-invoice-line-item-attribute>
                          <sub-invoice-line-item-attribute id="bg-dex-08">
                            <item-attribute-name id="bt-160">[Description 2]</item-attribute-name>
                            <item-attribute-value id="bt-161">[Value 2]</item-attribute-value>
                          </sub-invoice-line-item-attribute>
                        </sub-invoice-line-item-attributes>
                      </sub-invoice-line-item-information>
              ...
              <third-party-payments id="bg-dex-09">
                <third-party-payment id="bg-dex-09">
                  <third-party-payment-type id="bt-dex-001">[third party payment type]</third-party-payment-type>
                  <third-party-payment-amount id="bt-dex-002">1200.00</third-party-payment-amount>
                  <third-party-payment-description id="bt-dex-003">[third party payment description 1]</third-party-payment-description>
                </third-party-payment>
                <third-party-payment id="bg-dex-09">
                  <third-party-payment-type id="bt-dex-001">[third party payment type]</third-party-payment-type>
                  <third-party-payment-amount id="bt-dex-002">1200.00</third-party-payment-amount>
                  <third-party-payment-description id="bt-dex-003">[third party payment description 2]</third-party-payment-description>
                </third-party-payment>
        ...
        Invoice expected = new Invoice
        {
                        ...
                        new SubInvoiceLine
                        {
                            ...
                            SubInvoiceLineItemInformation = new SubInvoiceLineItemInformation
                            {
                                ...
                                SubInvoiceLineItemAttributes = [
                                    new SubInvoiceLineItemAttribute {
                                       ItemAttributeName = new Text("[Description]"),
                                       ItemAttributeValue = new Text ("[Value]"),
                                    },
                                    new SubInvoiceLineItemAttribute {
                            ...
                            SubInvoiceLinePeriod = new SubInvoiceLinePeriod
                            {
                                InvoiceLinePeriodStartDate = new Date(new DateTime(2018, 04, 13)),
                                InvoiceLinePeriodEndDate = new Date(new DateTime(2018, 04, 13)),
                            },
            ...
            ThirdPartyPayments = [
                ...
                {
                    ThirdPartyPaymentType = new Text("[third party payment type]"),
                    ThirdPartyPaymentAmount = new Amount(1200.00m),
                    ThirdPartyPaymentDescription = new Text("[third party payment description 1]"),
                },
                new ThirdPartyPayment
                {
                    ThirdPartyPaymentType = new Text("[third party payment type]"),
                    ThirdPartyPaymentAmount = new Amount(1200.00m),
                    ThirdPartyPaymentDescription = new Text("[third party payment description 2]"),
                },
            ],
        };
    ...
    [Fact]
    public void SerializeThirdPartyPayment()
    {
        string xml = """
            <third-party-payment id="bg-dex-09" xmlns="urn:todo">
              <third-party-payment-type id="bt-dex-001">[third party payment type]</third-party-payment-type>
              <third-party-payment-amount id="bt-dex-002">1200.00</third-party-payment-amount>
              <third-party-payment-description id="bt-dex-003">[third party payment description 1]</third-party-payment-description>
            </third-party-payment>
        ...
        ThirdPartyPayment expected = new ThirdPartyPayment
        {
            ThirdPartyPaymentType = new Text("[third party payment type]"),
            ThirdPartyPaymentAmount = new Amount(1200.00m),
            ThirdPartyPaymentDescription = new Text("[third party payment description 1]"),
        ...
        var actual = ThirdPartyPayment.Deserialize(xmlReader);
    ...
    [Fact]
    public void SerializeSubInvoiceLine()
    {
        string xml = """
            <sub-invoice-line id="bg-dex-01" xmlns="urn:todo">
              <invoice-line-identifier id="bt-126">
                <content>1</content>
              </invoice-line-identifier>
              <invoice-line-note id="bt-127">Die letzte Lieferung im Rahmen des abgerechneten Abonnements erfolgt in 12/2016 Lieferung erfolgt / erfolgte direkt vom Verlag</invoice-line-note>
        ...
        SubInvoiceLine expected = new SubInvoiceLine
        {
            InvoiceLineIdentifier = new Identifier("1"),
            InvoiceLineNote = new Text("Die letzte Lieferung im Rahmen des abgerechneten Abonnements erfolgt in 12/2016 Lieferung erfolgt / erfolgte direkt vom Verlag"),
            InvoiceLineObjectIdentifier = new Identifier("ANG987654321", "ABZ"),
        ...
        var actual = SubInvoiceLine.Deserialize(xmlReader);

        Assert.Equal(expected, actual);
    }

    [Fact]
    public void SerializeSubInvoiceLineItemInformation()
    {
        string xml = """
            <sub-invoice-line-item-information id="bg-dex-02" xmlns="urn:todo">
              <item-name id="bt-153">Beratung</item-name>
              <item-description id="bt-154">Anforderungsmanagement</item-description>
              <item-sellers-identifier id="bt-155">
                <content>1034</content>
        ...
        SubInvoiceLineItemInformation expected = new SubInvoiceLineItemInformation
        {
            ItemName = new Text("Beratung"),
            ItemDescription = new Text("Anforderungsmanagement"),
            ItemSellersIdentifier = new Identifier("1034"),
        ...
        var actual = SubInvoiceLineItemInformation.Deserialize(xmlReader);
